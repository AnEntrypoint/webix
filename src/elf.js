...
export function parseELF64(bytes) {
  ...
  const header = {
    type: dv.getUint16(16, true), machine, version: dv.getUint32(20, true),
    entry: dv.getBigUint64(24, true), phoff: dv.getBigUint64(32, true), shoff: dv.getBigUint64(40, true),
    flags: dv.getUint32(48, true), ehsize: dv.getUint16(52, true),
    phentsize: dv.getUint16(54, true), phnum: dv.getUint16(56, true),
    shentsize: dv.getUint16(58, true), shnum: dv.getUint16(60, true), shstrndx: dv.getUint16(62, true),
  };
